...
<button id="sign-in" class="button is-success">Sign in</button>
<button id="sign-out" class="button is-danger">Sign Out</button>
 </form>
 `;
document.querySelector(".login").innerHTML = formLogin;
...
document
  .querySelector("#check-user")
  .addEventListener("click", () => console.log(auth.currentUser.email));
